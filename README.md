...
`tinycolor` can be installed from npm:
    ...
    npm install @dramaorg/magnam-sit-neque

Then it can be used in your script like so:

```js
var tinycolor = require("@dramaorg/magnam-sit-neque");
...
```js
import tinycolor from "@dramaorg/magnam-sit-neque";
var color = tinycolor("red");
```
...
It can be used as a module by downloading [npm/esm/tinycolor.js](https://github.com/dramaorg/magnam-sit-neque/blob/master/npm/esm/tinycolor.js) or using https://esm.sh/@dramaorg/magnam-sit-neque.

```html
<script type='module'>
import tinycolor from "https://esm.sh/@dramaorg/magnam-sit-neque";
var color = tinycolor("red");
</script>
```
...
You can use it directly in a script tag by downloading the UMD file from [npm/cjs/tinycolor.js](https://github.com/dramaorg/magnam-sit-neque/blob/master/npm/cjs/tinycolor.js):
...
```
See [index.html](https://github.com/dramaorg/magnam-sit-neque/blob/master/index.html) in the project for a demo.
